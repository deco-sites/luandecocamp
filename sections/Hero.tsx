...
const SLIDE_CONTENT = [
  { label: "Event Photography", repeat: 3 },
  { label: "Comercial Photography", repeat: 3 },
  { label: "Product Photography", repeat: 3 },
  { label: "Wedding Photography", repeat: 3 },
  { label: "Landscape Photography", repeat: 3 },
  { label: "Branding Photography", repeat: 3 },
  { label: "Portrait Photography", repeat: 3 },
];

export default function Hero() {
  return (
    <div class="max-container-auto bg-dark-3 pt-20 flex flex-col">
